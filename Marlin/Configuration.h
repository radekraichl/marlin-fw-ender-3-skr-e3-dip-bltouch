...
#define STRING_CONFIG_H_AUTHOR "(Radek Raichl, Ender-3)" // Who made the changes.
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  #define DEFAULT_bedKp  39.10
  #define DEFAULT_bedKi   4.33
  #define DEFAULT_bedKd 235.70
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -52, -16, -4.5 }
...
#define Z_PROBE_FEEDRATE_FAST 35
...
#define HOMING_FEEDRATE_MM_M { (40*60), (40*60), (4*80) }
